...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater,
        ...
        for (int offset = 0; offset < 7; offset++) {
            Logr.d("getDayOfWeek" + getDayOfWeek(firstDayOfWeek, offset, view.isRtl) + "  offset " + offset);
            today.set(Calendar.DAY_OF_WEEK, getDayOfWeek(firstDayOfWeek, offset, view.isRtl));
            final TextView textView = (TextView) headerRow.getChildAt(offset);
            Logr.d("weekdayNameFormat" + weekdayNameFormat.format(today.getTime()));
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    cellView.setVisibility(cell.isSelectable() ? VISIBLE : INVISIBLE);
