...
public class CalendarCellView extends LinearLayout {
    ...
    private TextView dayOfMonthTextView, dayFooterTextView;
    ...
    public void setDayFooterTextView(TextView textView) {
        dayFooterTextView = textView;
    }
    ...
    public void setDayLayout(LinearLayout layout) {
        this.dayLayout = layout;
    }

    public void setDateBackground(int dateBackground) {
        this.dayLayout.setBackgroundResource(dateBackground);
    }
}
